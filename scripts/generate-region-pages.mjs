...
<head>
  ...
  <script src="../js/main.js?v=20260730-5" defer></script>
...
${priceCards(region)}
  ...
  <footer class="site-footer">
    <div class="container footer-main"><div class="footer-brand"><a class="brand" href="../" aria-label="평택출장마사지 메인 페이지"><img class="brand-logo" src="../images/logo-pyeongtaek.png" width="1200" height="221" alt="평택출장마사지"></a><p>${region.name} 생활권의 자택과 숙소로 방문하는 예약제 휴식·바디 케어 서비스를 안내합니다.</p></div><dl class="business-info"><div><dt>상호명</dt><dd data-config-business>상호명 입력</dd></div><div><dt>대표자</dt><dd>대표자명 입력</dd></div><div><dt>연락처</dt><dd><a href="tel:050718598915" data-action="phone-click" data-config-phone>0507-1859-8915</a></dd></div><div><dt>주소</dt><dd>주소 입력</dd></div><div><dt>운영지역</dt><dd>${region.name} 및 평택 전 지역</dd></div></dl></div>
