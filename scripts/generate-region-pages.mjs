...
function faqItems(region) {
  return [
    ...
    },
    {
      ...
      answer: `현재 ${region.name} 내 위치 또는 가까운 건물명, 희망 시작시간, 이용 장소와 원하는 코스를 전화나 문자, 카카오톡으로 전달해 주세요.`
    },
    {
  ...
  return `
        <div class="price-grid">
          <article class="price-card">
            ...
            <a class="button button--dark button--full" href="sms:010-0000-0000" data-action="sms-click" data-course="${region.name} 타이 코스">타이 코스 문의</a>
          </article>
          <article class="price-card price-card--featured">
            ...
            <a class="button button--gold button--full" href="sms:010-0000-0000" data-action="sms-click" data-course="${region.name} 아로마 코스">아로마 코스 문의</a>
          </article>
          <article class="price-card">
            ...
            <a class="button button--dark button--full" href="sms:010-0000-0000" data-action="sms-click" data-course="${region.name} 스페셜 코스">스페셜 코스 문의</a>
          </article>
        </div>`;
}
...
<head>
  ...
  <script src="../js/main.js?v=20260730-2" defer></script>
  ...
  <header class="site-header" data-header>
    <div class="container header-inner">
      ...
      <nav class="primary-nav" id="primary-navigation" aria-label="주요 메뉴" data-nav>
        ...
        <a class="button button--small button--gold nav-call" href="tel:010-0000-0000" data-action="phone-click">전화상담</a>
      </nav>
    </div>
  </header>
    ...
    <section class="hero" id="top" aria-labelledby="hero-title">
      ...
      <div class="container hero-inner">
        <div class="hero-copy">
          ...
          <div class="hero-actions" aria-label="상담 방법"><a class="button button--gold" href="tel:010-0000-0000" data-action="phone-click"><span aria-hidden="true">☎</span> 전화 상담</a><a class="button button--light" href="sms:010-0000-0000" data-action="sms-click"><span aria-hidden="true">✉</span> 문자 예약</a><a class="button button--ghost" href="#" data-action="kakao-click"><span class="kakao-dot" aria-hidden="true">K</span> 카카오톡</a></div>
...
${priceCards(region)}
    ...
    <section class="section section--cream" id="faq" aria-labelledby="faq-title">
      <div class="container faq-layout">
        <div class="faq-intro"><p class="eyebrow eyebrow--dark"><span></span> ${region.slug.toUpperCase()} FAQ</p><h2 id="faq-title">${region.name}출장마사지 FAQ</h2><p>${region.name} 생활권 예약 전에 자주 확인하는 내용을 정리했습니다. 실제 운영 조건은 상담 시 안내가 우선합니다.</p><a class="button button--dark" href="tel:010-0000-0000" data-action="phone-click">다른 내용 전화로 묻기</a></div>
    ...
    <section class="final-cta" aria-labelledby="final-title">
      <div class="final-cta__glow" aria-hidden="true"></div><div class="container final-cta__inner"><p class="eyebrow"><span></span> ${region.slug.toUpperCase()} RESERVATION</p><h2 id="final-title">${region.name} 현재 위치와<br>희망 시간을 알려주세요</h2><p>이용 가능한 코스와 예상 방문시간을 확인해 안내합니다.</p><div class="final-actions"><a class="button button--gold" href="tel:010-0000-0000" data-action="phone-click">전화하기</a><a class="button button--light" href="sms:010-0000-0000" data-action="sms-click">문자 보내기</a><a class="button button--ghost" href="#" data-action="kakao-click">카카오톡 상담</a></div><p class="final-note">상담 시 <strong>${region.name} 내 위치 · 희망 시간 · 코스</strong>를 함께 보내주세요.</p></div>
    </section>
  </main>
  <footer class="site-footer">
    <div class="container footer-main"><div class="footer-brand"><a class="brand" href="../" aria-label="평택출장마사지 메인 페이지"><img class="brand-logo" src="../images/logo-pyeongtaek.png" width="1200" height="221" alt="평택출장마사지"></a><p>${region.name} 생활권의 자택과 숙소로 방문하는 예약제 휴식·바디 케어 서비스를 안내합니다.</p></div><dl class="business-info"><div><dt>상호명</dt><dd data-config-business>상호명 입력</dd></div><div><dt>대표자</dt><dd>대표자명 입력</dd></div><div><dt>연락처</dt><dd><a href="tel:010-0000-0000" data-action="phone-click" data-config-phone>010-0000-0000</a></dd></div><div><dt>주소</dt><dd>주소 입력</dd></div><div><dt>운영지역</dt><dd>${region.name} 및 평택 전 지역</dd></div></dl></div>
    ...
    <div class="footer-bottom"><div class="container"><p>© <span data-current-year>2026</span> <span data-config-business>상호명 입력</span>. All rights reserved.</p><p>본 서비스는 의료 행위가 아닌 일반적인 휴식·바디 케어 안내입니다.</p></div></div>
  </footer>
  <nav class="mobile-cta" aria-label="빠른 상담"><a href="tel:010-0000-0000" data-action="phone-click"><span aria-hidden="true">☎</span>전화</a><a href="sms:010-0000-0000" data-action="sms-click"><span aria-hidden="true">✉</span>문자</a><a href="#" data-action="kakao-click"><span class="kakao-dot" aria-hidden="true">K</span>카카오톡</a></nav>
...
for (const region of regions) {
  ...
  await writeFile(targetFile, renderPage(region), { encoding: "utf8", flag: "wx" });
  console.log(`Created ${region.slug}/index.html`);
}
