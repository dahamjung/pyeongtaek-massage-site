...
- [x] 푸터 대표자명, 주소, 연락처
- [x] 개인정보처리방침 전문과 개인정보 문의처
- [x] 이용약관, 예약 변경·취소 및 결제 안내 원칙
- [x] 상담 24시간, 방문 범위, 선입금 없음 등 실제 운영 조건 확인
- [x] 현금·계좌이체·카드 결제와 일부 외곽지역 추가 비용 안내
- [x] 예약 요청 후 5분 이내 비용 없는 취소 안내
- [x] 상담 문자·전화 기록 비보유 원칙
